...
urlpatterns = [
    ...
    path('OB/board_edit/<int:pk>/',
         views.UpdateViewBoradView.as_view(), name='board-edit'),
    path('OB/board_detail/<int:pk>/',
         views.DetailBoardView.as_view(), name='board-detail'),
    path('OB/opinion_create/', views.CreateOpinionView.as_view(),
         name='opinion-create'),
    ...
    path('select_destination/<slug:user_id>/',
         views.GetDestinationInfo, name='select'),
    ...
    path('confirmShiftAuthor/', views.confirmShiftAuthor,
         name='confirmShiftAuthor'),
