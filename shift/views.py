...
from django.http import Http404, HttpResponse, JsonResponse, HttpResponseRedirect #シフト編集・閲覧
import time #給料計算
import json #シフト編集・閲覧
from .forms import CalendarForm, ShiftForm, ConfirmForm #jsonバリデーションチェック（シフト編集・閲覧）
from django.middleware.csrf import get_token #カレンダー表示
